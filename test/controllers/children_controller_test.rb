...
class ChildrenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post children_url, params: { child: { documents: @child.documents, name: @child.name, pictures: @child.pictures, status: @child.status } }
    end
  ...
  test "should update child" do
    patch child_url(@child), params: { child: { documents: @child.documents, name: @child.name, pictures: @child.pictures, status: @child.status } }
